...
var AppModelFormComponent = /** @class */ (function () {
    function AppModelFormComponent() {
        this.personModel = { firstname: 'form service' };
    }
    AppModelFormComponent.prototype.SaveData = function (frm) {
    ...
    AppModelFormComponent = __decorate([
        core_1.Component({
            selector: 'mymodelform',
    ...
    return AppModelFormComponent;
}());
exports.AppModelFormComponent = AppModelFormComponent;
